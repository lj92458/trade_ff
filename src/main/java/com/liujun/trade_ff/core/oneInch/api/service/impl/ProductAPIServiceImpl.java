...
import com.liujun.trade_ff.core.oneInch.api.rpc.ProductRpc;
...
public class ProductAPIServiceImpl implements ProductAPIService {
     ...
     */
    @Override
    public Book bookProductsByProductId(String coinPair, double goodsAmount, double moneyAmount) {

        int maxRetry = 5;
        for (int retryCount = 0; ; retryCount++) {
            try {
                Book book = productRpc.bookProductOneInch(coinPair, goodsAmount, moneyAmount).toFuture().get(15L, TimeUnit.SECONDS);
                return book;
            } catch (Exception e) {
