package com.liujun.trade_ff.core.oneInch.api.service.impl;
...
import com.liujun.trade_ff.core.oneInch.api.rpc.OrderRpc;
import com.liujun.trade_ff.core.oneInch.api.rpc.RpcClient;
...
public class OrderApiServiceImpl implements OrderAPIService {
     ...
     */
    @Override
    public TransResult addOrder(String coinPair, String orderType, String price, String volume, String gasPriceGwei, double slippage) {

        try {
            log.info("开始调用orderRpc.addOrderOneInch");
            //failed to meet quorum 不一定代表失败呢
            TransResult transResult = orderRpc.addOrderOneInch(coinPair, orderType, price, volume, config.getMaxWaitSeconds(), gasPriceGwei, slippage).toFuture().get(config.getMaxWaitSeconds(), TimeUnit.SECONDS);
