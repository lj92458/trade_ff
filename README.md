...
- **零转账资金自回补（原创设计）** — 当某平台资金耗尽时，系统不强制跨链转账补充，而是等待差价自然反转，通过反向交易自动回补资金。这种"舍弃"转账能力的设计，反而让系统更简单、更安全、更低成本，并能适配任何多平台交易品种（如 A 股 ETF、体育博彩等），即使不支持跨链转账也能运行
...
- 🔄 **零转账自回补** — 资金耗尽时不搬运，等差价反转自然回补，零风险零费用，适配任意多平台品种
